...
public class ChevronLeftIcon implements Icon {
    ...
    public ChevronLeftIcon(int size) {
        this(size, size);
    }

    public ChevronLeftIcon(int width, int height) {
        this.width = width;
        this.height = height;
    }
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        // < shape
        p.moveTo(width - pad, height * 0.15f);
        p.lineTo(pad, height * 0.5f);
        p.lineTo(width - pad, height * 0.85f);
