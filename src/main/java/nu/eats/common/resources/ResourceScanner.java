    ...
    public static void scan(String directory, Consumer<Path> fileConsumer) {
        try {
            ...
            while (resources.hasMoreElements()) {
                walkUrl(resources.nextElement(), directory, fileConsumer);
            }
        } catch (Exception e) {
            throw new RuntimeException("Resource scan failed for: " + directory, e);
        }
    }

    private static void walkUrl(URL url, String directory, Consumer<Path> fileConsumer) throws Exception {
